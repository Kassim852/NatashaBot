...
async def start(client, message):
    ...
    if message.chat.type != "private":
        buttons = InlineKeyboardMarkup(
            ...
            ],[InlineKeyboardButton(text="💠 ʏᴏᴜᴛᴜʙᴇ 💠",
                url="https://youtube.com/channel/UCtI7hbY-BD7wvuIzoSU0cEw")]])
        Photo = "https://te.legra.ph/file/535a7db55e251a316b807.jpg"
...
ꜰɪʀꜱᴛ ᴀᴅᴅ ᴛʜɪꜱ ʙᴏᴛ ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴀɴᴅ ᴏᴘᴇɴ ᴛʜᴇ /ᴄʜᴀᴛʙᴏᴛ ᴏɴ ᴀꜰᴛᴇʀ ᴛʜɪꜱ ʏᴏᴜ ᴡɪʟʟ ᴜɴᴅᴇʀꜱᴛᴀɴᴅ ᴀʟʟ ᴛʜᴇ ᴛʜɪɴɢꜱ.\n───────────────────\n""",
        ...
        buttons = [[
            InlineKeyboardButton("➕ ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ➕", url=f"https://t.me/NatashaChatbot?startgroup=true")
        ],
        ...
        Photo = "https://te.legra.ph/file/10b742e61c27e6ac8e320.jpg"
    ...
    if message.chat.type != "private":
        buttons = InlineKeyboardMarkup(
            [[InlineKeyboardButton(text="ᴄʟɪᴄᴋ ʜᴇʀᴇ",
                url=f"t.me/NatashaChatbot?start=help_")]])
        Photo = "https://te.legra.ph/file/535a7db55e251a316b807.jpg"
...
async def chatbot(client, message):
        await message.reply_photo("https://te.legra.ph/file/535a7db55e251a316b807.jpg")
        await message.reply_text(f"""**ʜᴏᴡ ᴛᴏ ᴜsᴇ ɴᴀᴛᴀsʜᴀ:**\n➛ sᴘᴇᴄɪᴀʟ ғᴇᴀᴛᴜʀᴇs:\nᴛʜɪꜱ ʙᴏᴛ ᴏʙꜱᴇʀᴠᴇ ᴀʟʟ ᴛʜᴇ ɢʀᴏᴜᴘ ᴄʜᴀᴛ ᴀɴᴅ ꜱᴛᴏʀᴇ ᴀʟʟ ᴛʜᴇ ᴄʜᴀᴛ ɪɴ  ᴅᴀᴛᴀ ᴀɴᴅ  ᴀʟꜱᴏ ɢɪᴠᴇ ʏᴏᴜʀ ʀᴇᴘʟʏ ᴀꜰᴛᴇʀ ᴅᴀᴛᴀ ᴀɴʏʟʏꜱɪꜱ 
